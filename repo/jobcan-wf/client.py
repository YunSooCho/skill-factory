"""
Jobcan Workflow Integration API Client

This module provides a Python client for interacting with jobcan-wf.
"""
...
class JobcanWfClient:
    """
    Client for jobcan-wf API integration.

    Provides comprehensive access to jobcan-wf's functionality.
    """
    ...
    def __init__(
        ...
        base_url: str = "https://api.jobcan.jp",
        timeout: int = 30
    ):
        """Initialize the JobcanWfClient client."""
