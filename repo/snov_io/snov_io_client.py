"""
Email finding and verification API Client
Sales
"""
...
class SnovIoClient:
    ...
    def __init__(self, api_key: str):
        """
        Initialize SnovIoClient API client.
        ...
        try:
            async with self.session.request(
                ...
                if response.status >= 400:
                    ...
                    raise Exception(f"SnovIoClient API error ({response.status}): {error_msg}")
            ...
            raise Exception(f"Error during SnovIoClient API request: {str(e)}")


    # ==================== API Methods ====================

    async def find_email:
        """Placeholder for find_email.
