...
> SafetyCulture provides safety management tools.
...
Get your API credentials from safetyculture:

1. Sign up at the official safetyculture website
...
```python
from safetyculture import SafetyCultureClient
...
For more information, visit the official safetyculture documentation.
