...
> Acuity Scheduling is an online appointment scheduling software.
...
Get your API credentials from acuity-scheduling:

1. Sign up at the official acuity-scheduling website
...
```python
from acuityscheduling import AcuitySchedulingClient

# Initialize with API key
client = AcuitySchedulingClient(
...
For more information, visit the official acuity-scheduling documentation.
