...
Python async client for Universal payment gateway service. Payment.
...
```python
import asyncio
from univapay_client import UnivapayClient

async def main():
    api_key = "your_api_key_here"

    async with UnivapayClient(api_key) as client:
        # List items
