"""
Digital product sales and payment platform API Client
...
class GumroadClient:
    """
    Async client for Digital product sales and payment platform
    ...
    def __init__(
        ...
        self.base_url = base_url or "https://api.gumroad.com/v2"
    ...
    async def list_products(self, **kwargs) -> GumroadResponse:
        """
        List Products
    ...
    async def get_product(self, **kwargs) -> GumroadResponse:
        """
        Get Product
    ...
    async def list_sales(self, **kwargs) -> GumroadResponse:
        """
        List Sales
    ...
    async def get_item(self, item_id: str) -> GumroadResponse:
        ...
        Returns:
            GumroadResponse with item details
        """

        return await self._request('GET', f'/items/{item_id}')

    async def create_item(self, data: Dict[str, Any]) -> GumroadResponse:
        """
        Create a new item
        ...
        Returns:
            GumroadResponse with created item
        """

        return await self._request('POST', '/items', data=data)

    async def update_item(self, item_id: str, data: Dict[str, Any]) -> GumroadResponse:
        """
        ...
        Returns:
            GumroadResponse with updated item
        """

        return await self._request('PUT', f'/items/{item_id}', data=data)

    async def delete_item(self, item_id: str) -> GumroadResponse:
        """
        Delete an item
    ...
    async def health_check(self) -> GumroadResponse:
        """
        Check API health status

        Returns:
            GumroadResponse with health status
        """
