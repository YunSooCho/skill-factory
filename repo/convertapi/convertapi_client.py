...
Yoom Apps Integration - Production-ready API client for convertapi
...
class ConvertapiClient:
    ...
    API Documentation: https://v2.convertapi.com
    """
    ...
    def __init__(
        ...
        """
        Initialize Convertapi API client.

        Args:
            api_key: Your Convertapi API key
    ...
    async def get_info(self, **kwargs) -> APIResponse:
        """
        get_info.
    ...
    async def list_formats(self, **kwargs) -> APIResponse:
        """
        list_formats.
        ...
        try:
            ...
            logger.error(f"list_formats failed: {e}")
            raise
...
async def main():
    """Example usage of ConvertapiClient"""
