...
Moneybird를 위한 Python API 클라이언트입니다. Dutch Accounting Platform.
...
```python
from moneybird import MoneybirdClient, MoneybirdError

client = MoneybirdClient(api_key="YOUR_API_KEY")
