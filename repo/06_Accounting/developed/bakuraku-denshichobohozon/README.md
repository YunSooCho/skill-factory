# Bakuraku Denshichobohozon API 클라이언트

Electronic book preservation platform를 위한 Python 클라이언트입니다.

## 개요

Electronic book preservation platform. 이 클라이언트는 OAuth 인증을 통해 Bakuraku Denshichobohozon API에 접근합니다.
