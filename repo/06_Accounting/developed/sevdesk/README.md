...
Sevdesk用のPython APIクライアント。 German Accounting Platform.
...
```python
from sevdesk import SevdeskClient, SevdeskError

client = SevdeskClient(api_key="YOUR_API_KEY")
