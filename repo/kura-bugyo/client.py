...
Complete client for Kura-Bugyo warehouse management integration.
...
class KuraBugyoAPIClient:
    """
    Complete client for Kura-Bugyo warehouse management.
    Supports inventory management and Japanese warehouse operations.
    """
    ...
    def __init__(
        ...
        self.api_key = api_key or os.getenv("KURA_BUGYO_API_KEY")
        self.base_url = base_url or os.getenv("KURA_BUGYO_BASE_URL", "https://api.kurabugyo.jp/v1")
        self.timeout = timeout
        self.verify_ssl = verify_ssl

        if not self.api_key:
            raise ValueError("API key is required. Set KURA_BUGYO_API_KEY environment variable.")
