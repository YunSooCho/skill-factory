"""
MailerLite Email API Actions implementation.
"""
import requests
import time
    ...
    def _make_request(
        ...
        try:
            ...
            if response.status_code == 401:
                ...
                raise MailerliteAuthenticationError(
                    message=error_data.get("message", "Authentication failed"),
                    status_code=401,
                    response=error_data,
                )
            elif response.status_code == 404:
                raise MailerliteNotFoundError(
                ...
                raise MailerliteRateLimitError(
            ...
            raise MailerliteError(f"Request timeout after {self.timeout} seconds")
        except requests.RequestException as e:
            raise MailerliteError(f"Request failed: {str(e)}")
