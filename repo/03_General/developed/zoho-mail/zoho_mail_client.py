...
Yoom Apps Integration - Production-ready API client for zoho-mail
...
class ZohoMailClient:
    ...
    API Documentation: https://mail.zoho.com/api
    """
    ...
    def __init__(
        ...
        """
        Initialize Zoho Mail API client.

        Args:
            api_key: Your Zoho Mail API key
    ...
    async def send_email(self, **kwargs) -> APIResponse:
        """
        send_email.
    ...
    async def get_email(self, **kwargs) -> APIResponse:
        """
        get_email.
    ...
    async def list_emails(self, **kwargs) -> APIResponse:
        """
        list_emails.
        ...
        try:
            ...
            logger.error(f"list_emails failed: {e}")
            raise

    async def delete_email(self, **kwargs) -> APIResponse:
        """
        delete_email.
        ...
        try:
            ...
            logger.error(f"delete_email failed: {e}")
            raise

    async def mark_as_read(self, **kwargs) -> APIResponse:
        """
        mark_as_read.
...
async def main():
    """Example usage of ZohoMailClient"""

    api_key = "your_api_key_here"

    async with ZohoMailClient(api_key=api_key) as client:
        try:
            # Example: List items
