...
class ManageClient:
    ...
    def __init__(self, api_key: str):
        """
        Initialize ManageClient API client.
        ...
        try:
            async with self.session.request(
                ...
                if response.status >= 400:
                    ...
                    raise Exception(f"ManageClient API error ({response.status}): {error_msg}")
            ...
            raise Exception(f"Error during ManageClient API request: {str(e)}")


    # ==================== API Methods ====================

    async def create_project:
        """Placeholder for create_project.
    ...
    async def update_project:
        """Placeholder for update_project.
