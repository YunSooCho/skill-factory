...
class LinkprintClient:
    ...
    def __init__(self, api_key: str):
        """
        Initialize LinkprintClient API client.
        ...
        try:
            async with self.session.request(
                ...
                if response.status >= 400:
                    ...
                    raise Exception(f"LinkprintClient API error ({response.status}): {error_msg}")
            ...
            raise Exception(f"Error during LinkprintClient API request: {str(e)}")


    # ==================== API Methods ====================

    async def create_link:
        """Placeholder for create_link.
    ...
    async def get_link_stats:
        """Placeholder for get_link_stats.
