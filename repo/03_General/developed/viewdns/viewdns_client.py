...
Yoom Apps Integration - Production-ready API client for viewdns
...
class ViewdnsClient:
    ...
    API Documentation: https://api.viewdns.info
    """
    ...
    def __init__(
        ...
        """
        Initialize Viewdns API client.

        Args:
            api_key: Your Viewdns API key
    ...
    async def dns_lookup(self, **kwargs) -> APIResponse:
        """
        dns_lookup.
        ...
        try:
            ...
            logger.error(f"dns_lookup failed: {e}")
            raise

    async def whois_lookup(self, **kwargs) -> APIResponse:
        """
        whois_lookup.
        ...
        try:
            ...
            logger.error(f"whois_lookup failed: {e}")
            raise

    async def reverse_ip(self, **kwargs) -> APIResponse:
        """
        reverse_ip.
        ...
        try:
            ...
            logger.error(f"reverse_ip failed: {e}")
            raise

    async def dns_records(self, **kwargs) -> APIResponse:
        """
        dns_records.
        ...
        try:
            ...
            logger.error(f"dns_records failed: {e}")
            raise

    async def subdomain_scan(self, **kwargs) -> APIResponse:
        """
        subdomain_scan.
        ...
        try:
            ...
            logger.error(f"subdomain_scan failed: {e}")
            raise
...
async def main():
    """Example usage of ViewdnsClient"""
