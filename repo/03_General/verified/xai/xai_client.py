...
Yoom Apps Integration - Production-ready API client for xai
...
class XaiClient:
    ...
    API Documentation: https://api.x.ai/v1
    """
    ...
    async def chat_completion(self, **kwargs) -> APIResponse:
        """
        chat_completion.
    ...
    async def list_models(self, **kwargs) -> APIResponse:
        """
        list_models.
    ...
    async def get_model(self, **kwargs) -> APIResponse:
        """
        get_model.
