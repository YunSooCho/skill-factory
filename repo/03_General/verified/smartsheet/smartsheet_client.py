...
Yoom Apps Integration - Production-ready API client for smartsheet
...
class SmartsheetClient:
    ...
    API Documentation: https://api.smartsheet.com/2.0
    """
    ...
    async def share_sheet(self, **kwargs) -> APIResponse:
        """
        share_sheet.
        ...
        try:
            ...
            logger.error(f"share_sheet failed: {e}")
            raise

    async def update_row(self, **kwargs) -> APIResponse:
        """
        update_row.
        ...
        try:
            ...
            logger.error(f"update_row failed: {e}")
            raise

    async def search_rows(self, **kwargs) -> APIResponse:
        """
        search_rows.
        ...
        try:
            ...
            logger.error(f"search_rows failed: {e}")
            raise

    async def get_row(self, **kwargs) -> APIResponse:
        """
        get_row.
        ...
        try:
            ...
            logger.error(f"get_row failed: {e}")
            raise

    async def add_user(self, **kwargs) -> APIResponse:
        """
        add_user.
    ...
    async def get_discussion(self, **kwargs) -> APIResponse:
        """
        get_discussion.
        ...
        try:
            ...
            logger.error(f"get_discussion failed: {e}")
            raise

    async def add_comment(self, **kwargs) -> APIResponse:
        """
        add_comment.
    ...
    async def list_discussions(self, **kwargs) -> APIResponse:
        """
        list_discussions.
        ...
        try:
            ...
            logger.error(f"list_discussions failed: {e}")
            raise

    async def add_row(self, **kwargs) -> APIResponse:
        """
        add_row.
    ...
    async def create_sheet(self, **kwargs) -> APIResponse:
        """
        create_sheet.
    ...
    async def delete_row(self, **kwargs) -> APIResponse:
        """
        delete_row.
        ...
        try:
            ...
            logger.error(f"delete_row failed: {e}")
            raise

    async def create_folder(self, **kwargs) -> APIResponse:
        """
        create_folder.
    ...
    async def attach_file_to_sheet(self, **kwargs) -> APIResponse:
        """
        ...
        try:
            response = await self._request(
                "POST",
                f"/attach-file-to-sheet",
                data=data
            )
            return response

        except Exception as e:
            logger.error(f"attach_file_to_sheet failed: {e}")
            raise

    async def attach_file_to_row(self, **kwargs) -> APIResponse:
        """
        attach_file_to_row.
        ...
        try:
            response = await self._request(
                "POST",
                f"/attach-file-to-row",
                data=data
            )
            return response

        except Exception as e:
            logger.error(f"attach_file_to_row failed: {e}")
            raise
...
async def main():
    """Example usage of SmartsheetClient"""
