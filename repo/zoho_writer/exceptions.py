"""
 Zoho Writer API Exceptions
"""


class ZohoWriterError(Exception):
    """Base exception for Zoho Writer API errors"""
...
class RateLimitError(ZohoWriterError):
...
class AuthenticationError(ZohoWriterError):
...
class ResourceNotFoundError(ZohoWriterError):
...
class ValidationError(ZohoWriterError):
