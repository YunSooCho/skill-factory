# Google Analytics API クライアント

Google Analytics用のPython APIクライアント。

## 概要

このクライアントはGoogle Analytics APIにアクセスし、さまざまなCRUD操作とイベント処理をサポートします。
...
1. Google Analytics開発者ポータルでアプリを作成する
2. APIキー/トークン発行
