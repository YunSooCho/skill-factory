...
class #RebrandlyClient:
    """
    # Rebrandly API Client with rate limiting and error handling
    """
    
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
        """
        Initialize # Rebrandly API client
        
        Args:
            api_key: API key for authentication
            base_url: Base URL for API endpoints
        """
        self.api_key = api_key or os.getenv(f"REBRANDLY_API_KEY")
        self.base_url = base_url or "https://api.rebrandly.com/v1"
    ...
    async def get_link(self, **kwargs) -> Dict[str, Any]:
        """
        Get Link
    ...
    async def update_link(self, **kwargs) -> Dict[str, Any]:
        """
        Update Link
    ...
    async def search_links(self, **kwargs) -> Dict[str, Any]:
        """
        Search Links
        ...
        Returns:
            Response data
        """
        endpoint = "/search_links"
        return await self._request("POST", endpoint, data=kwargs)

    async def delete_tag_from_link(self, **kwargs) -> Dict[str, Any]:
        """
        ...
        Returns:
            Response data
        """
        endpoint = "/delete_tag_from_link"
        return await self._request("POST", endpoint, data=kwargs)

    async def create_tag(self, **kwargs) -> Dict[str, Any]:
        """
        Create Tag
    ...
    async def create_link(self, **kwargs) -> Dict[str, Any]:
        """
        Create Link
    ...
    async def delete_link(self, **kwargs) -> Dict[str, Any]:
        """
        Delete Link
    ...
    async def add_tag_to_link(self, **kwargs) -> Dict[str, Any]:
        """
        Add Tag to Link
        ...
        Returns:
            Response data
        """
        endpoint = "/add_tag_to_link"
        return await self._request("POST", endpoint, data=kwargs)

    async def handle_new_link_trigger(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """
        Handle New Link trigger event
