...
class #MixpanelClient:
    """
    # Mixpanel API Client with rate limiting and error handling
    """
    ...
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
        ...
        """
        self.api_key = api_key or os.getenv(f"MIXPANEL_API_KEY")
        self.base_url = base_url or "https://api.mixpanel.com"
    ...
    async def create_or_update_profile(self, **kwargs) -> Dict[str, Any]:
        """
        ...
        Returns:
            Response data
        """
        endpoint = "/create_or_update_profile"
        return await self._request("POST", endpoint, data=kwargs)

    async def delete_property(self, **kwargs) -> Dict[str, Any]:
        """
        Delete Property
    ...
    async def delete_profile(self, **kwargs) -> Dict[str, Any]:
        """
        Delete Profile
    ...
    async def track_event(self, **kwargs) -> Dict[str, Any]:
        """
        Track Event
