#Mailerlite APIクライアント

Mailerlite用のPython APIクライアント。

## 概要

このクライアントはMailerlite APIにアクセスし、さまざまなCRUD操作とイベント処理をサポートします。
