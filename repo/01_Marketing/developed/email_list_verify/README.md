# Email List Verify API クライアント

Email List Verify用のPython APIクライアント。

## 概要

このクライアントはEmail List Verify APIにアクセスし、さまざまなCRUD操作とイベント処理をサポートします。
...
1. Email List Verify 開発者ポータルでアプリを作成する
2. APIキー/トークン発行
