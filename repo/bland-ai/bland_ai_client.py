...
Yoom Apps Integration - Production-ready API client for bland-ai
...
class BlandAiClient:
    ...
    API Documentation: https://api.bland.ai/v1
    """
    ...
    async def create_call(self, **kwargs) -> APIResponse:
        """
        create_call.
    ...
    async def get_call(self, **kwargs) -> APIResponse:
        """
        get_call.
        ...
        try:
            ...
            logger.error(f"get_call failed: {e}")
            raise

    async def list_calls(self, **kwargs) -> APIResponse:
        """
        list_calls.
        ...
        try:
            ...
            logger.error(f"list_calls failed: {e}")
            raise

    async def end_call(self, **kwargs) -> APIResponse:
        """
        end_call.
    ...
    async def analyze_call(self, **kwargs) -> APIResponse:
        """
        analyze_call.
        ...
        try:
            ...
            logger.error(f"analyze_call failed: {e}")
            raise
...
async def main():
    """Example usage of BlandAiClient"""

    api_key = "your_api_key_here"

    async with BlandAiClient(api_key=api_key) as client:
        try:
            # Example: List items
