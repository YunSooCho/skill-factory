# TimelinesAI API 클라이언트

Timeline and schedule management를 위한 Python 클라이언트입니다.

## 개요

Timeline and schedule management. 이 클라이언트는 OAuth 인증을 통해 TimelinesAI API에 접근합니다.
