...
class #PostalyticsClient:
    """
    # Postalytics API Client with rate limiting and error handling
    """
    
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
        """
        Initialize # Postalytics API client
        
        Args:
            api_key: API key for authentication
            base_url: Base URL for API endpoints
        """
        self.api_key = api_key or os.getenv(f"POSTALYTICS_API_KEY")
        self.base_url = base_url or "https://api.postalytics.com"
    ...
    async def list_contact_lists(self, **kwargs) -> Dict[str, Any]:
        """
        List Contact Lists
    ...
    async def list_contacts(self, **kwargs) -> Dict[str, Any]:
        """
        List Contacts
    ...
    async def send_mail(self, **kwargs) -> Dict[str, Any]:
        """
        Send Mail
    ...
    async def list_drip_campaigns(self, **kwargs) -> Dict[str, Any]:
        """
        List Drip Campaigns
