# SignUpGenius API 클라이언트

Online sign up and scheduling platform를 위한 Python 클라이언트입니다.

## 개요

Online sign up and scheduling platform. 이 클라이언트는 OAuth 인증을 통해 SignUpGenius API에 접근합니다.
