"""
Wrike API Client - Project management and collaboration
"""
...
class WrikeError(Exception):
    """Base exception for Wrike errors"""
    pass
...
class WrikeAuthenticationError(WrikeError):
    """Authentication failed"""
    pass


class WrikeClient:
    """Client for Wrike API"""
    ...
    def __init__(self, access_token: str, timeout: int = 30):
        ...
        Args:
            access_token: Wrike OAuth access token
    ...
    def _handle_response(self, response: requests.Response) -> Dict[str, Any]:
        ...
        if response.status_code == 401:
            raise WrikeAuthenticationError("Authentication failed")
        ...
        if response.status_code >= 400:
            ...
            raise WrikeError(f"API error ({response.status_code}): {error_msg}")
    ...
    def get_tasks(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            raise WrikeError(f"Request failed: {str(e)}")
