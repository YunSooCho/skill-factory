"""
CRM and sales automation API Client
Sales
"""
...
class SalesmateClient:
    ...
    def __init__(self, api_key: str):
        """
        Initialize SalesmateClient API client.
        ...
        try:
            async with self.session.request(
                ...
                if response.status >= 400:
                    ...
                    raise Exception(f"SalesmateClient API error ({response.status}): {error_msg}")
            ...
            raise Exception(f"Error during SalesmateClient API request: {str(e)}")
