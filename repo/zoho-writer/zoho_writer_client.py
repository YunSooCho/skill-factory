...
Yoom Apps Integration - Production-ready API client for zoho-writer
...
class ZohoWriterClient:
    ...
    API Documentation: https://writer.zoho.com/api/v1
    """
    ...
    def __init__(
        ...
        """
        Initialize Zoho Writer API client.

        Args:
            api_key: Your Zoho Writer API key
    ...
    async def create_document(self, **kwargs) -> APIResponse:
        """
        create_document.
    ...
    async def get_document(self, **kwargs) -> APIResponse:
        """
        get_document.
    ...
    async def update_document(self, **kwargs) -> APIResponse:
        """
        update_document.
    ...
    async def export_document(self, **kwargs) -> APIResponse:
        """
        export_document.
...
async def main():
    """Example usage of ZohoWriterClient"""
