"""Freshservice IT Service Desk API Client"""
import requests
...
class FreshserviceClient:
    ...
    def get_requesters(self, page: int = 1) -> List[Dict[str, Any]]:
        return self._request('GET', '/requesters', params={'page': page})

    def get_assets(self, page: int = 1) -> List[Dict[str, Any]]:
        return self._request('GET', '/assets', params={'page': page})

    def create_asset(self, data: Dict[str, Any]) -> Dict[str, Any]:
        return self._request('POST', '/assets', data=data)

    def get_changes(self, page: int = 1) -> List[Dict[str, Any]]:
        return self._request('GET', '/changes', params={'page': page})

    def create_change(self, data: Dict[str, Any]) -> Dict[str, Any]:
        return self._request('POST', '/changes', data=data)