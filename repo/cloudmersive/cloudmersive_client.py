...
Yoom Apps Integration - Production-ready API client for cloudmersive
...
class CloudmersiveClient:
    ...
    API Documentation: https://api.cloudmersive.com
    """
    ...
    def __init__(
        ...
        """
        Initialize Cloudmersive API client.
    ...
    async def validate_email(self, **kwargs) -> APIResponse:
        """
        validate_email.
        ...
        try:
            ...
            logger.error(f"validate_email failed: {e}")
            raise

    async def convert_document(self, **kwargs) -> APIResponse:
        """
        convert_document.
        ...
        try:
            ...
            logger.error(f"convert_document failed: {e}")
            raise

    async def virus_scan(self, **kwargs) -> APIResponse:
        """
        virus_scan.
        ...
        try:
            ...
            logger.error(f"virus_scan failed: {e}")
            raise

    async def ocr_scan(self, **kwargs) -> APIResponse:
        """
        ocr_scan.
        ...
        try:
            ...
            logger.error(f"ocr_scan failed: {e}")
            raise
...
async def main():
    """Example usage of CloudmersiveClient"""
