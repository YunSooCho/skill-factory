...
> NotePM is a knowledge management platform.
...
Get your API credentials from notepm:

1. Sign up at the official notepm website
...
```python
from notepm import NotePMClient
...
For more information, visit the official notepm documentation.
