...
Yoom Apps Integration - Production-ready API client for trint
...
class TrintClient:
    ...
    API Documentation: https://api.trint.com/transcriptions
    """
    ...
    def __init__(
        ...
        """
        Initialize Trint API client.

        Args:
            api_key: Your Trint API key
    ...
    async def create_transcription(self, **kwargs) -> APIResponse:
        """
        ...
        try:
            response = await self._request(
                "POST",
                f"/create-transcription",
                data=data
            )
            return response

        except Exception as e:
            logger.error(f"create_transcription failed: {e}")
            raise

    async def get_transcription(self, **kwargs) -> APIResponse:
        """
        get_transcription.
        ...
        try:
            ...
            logger.error(f"get_transcription failed: {e}")
            raise

    async def list_transcriptions(self, **kwargs) -> APIResponse:
        """
        list_transcriptions.
        ...
        try:
            response = await self._request(
                "POST",
                f"/list-transcriptions",
                data=data
            )
            return response

        except Exception as e:
            logger.error(f"list_transcriptions failed: {e}")
            raise

    async def delete_transcription(self, **kwargs) -> APIResponse:
        """
        ...
        try:
            response = await self._request(
                "POST",
                f"/delete-transcription",
                data=data
            )
            return response

        except Exception as e:
            logger.error(f"delete_transcription failed: {e}")
            raise
...
async def main():
    """Example usage of TrintClient"""

    api_key = "your_api_key_here"

    async with TrintClient(api_key=api_key) as client:
        try:
            # Example: List items
