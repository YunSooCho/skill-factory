...
Yoom Apps Integration - Production-ready API client for cloudconvert
...
class CloudconvertClient:
    ...
    API Documentation: https://api.cloudconvert.com/v2
    """
    ...
    async def convert_file(self, **kwargs) -> APIResponse:
        """
        convert_file.
        ...
        try:
            ...
            logger.error(f"convert_file failed: {e}")
            raise
    ...
    async def get_job(self, **kwargs) -> APIResponse:
        """
        get_job.
...
async def main():
    """Example usage of CloudconvertClient"""

    api_key = "your_api_key_here"

    async with CloudconvertClient(api_key=api_key) as client:
        try:
            # Example: List items
