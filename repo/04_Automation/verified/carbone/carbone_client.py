...
Yoom Apps Integration - Production-ready API client for carbone
...
class CarboneClient:
    ...
    API Documentation: https://api.carbone.io
    """
    ...
    def __init__(
        ...
        """
        Initialize Carbone API client.

        Args:
            api_key: Your Carbone API key
    ...
    async def render_template(self, **kwargs) -> APIResponse:
        """
        render_template.
    ...
    async def delete_template(self, **kwargs) -> APIResponse:
        """
        delete_template.
...
async def main():
    """Example usage of CarboneClient"""
