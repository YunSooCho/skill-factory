...
Yoom Apps Integration - Production-ready API client for botpress
...
class BotpressClient:
    ...
    API Documentation: https://api.botpress.cloud/v1
    """
    ...
    def __init__(
        ...
        """
        Initialize Botpress API client.

        Args:
            api_key: Your Botpress API key
    ...
    async def create_bot(self, **kwargs) -> APIResponse:
        """
        create_bot.
        ...
        try:
            ...
            logger.error(f"create_bot failed: {e}")
            raise
    ...
    async def send_message(self, **kwargs) -> APIResponse:
        """
        send_message.
    ...
    async def get_analytics(self, **kwargs) -> APIResponse:
        """
        get_analytics.
...
async def main():
    """Example usage of BotpressClient"""

    api_key = "your_api_key_here"

    async with BotpressClient(api_key=api_key) as client:
        try:
            # Example: List items
