...
Yoom Apps Integration - Production-ready API client for apify
...
class ApifyClient:
    ...
    API Documentation: https://api.apify.com/v2
    """
    ...
    async def run_actor(self, **kwargs) -> APIResponse:
        """
        run_actor.
        ...
        try:
            ...
            logger.error(f"run_actor failed: {e}")
            raise

    async def get_actor(self, **kwargs) -> APIResponse:
        """
        get_actor.
        ...
        try:
            ...
            logger.error(f"get_actor failed: {e}")
            raise

    async def list_actors(self, **kwargs) -> APIResponse:
        """
        list_actors.
        ...
        try:
            ...
            logger.error(f"list_actors failed: {e}")
            raise

    async def get_run(self, **kwargs) -> APIResponse:
        """
        get_run.
    ...
    async def list_runs(self, **kwargs) -> APIResponse:
        """
        list_runs.
