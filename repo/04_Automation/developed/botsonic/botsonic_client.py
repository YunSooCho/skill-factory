...
Yoom Apps Integration - Production-ready API client for botsonic
...
class BotsonicClient:
    ...
    API Documentation: https://api.botsonic.com/v1
    """
    ...
    def __init__(
        ...
        """
        Initialize Botsonic API client.

        Args:
            api_key: Your Botsonic API key
    ...
    async def create_chatbot(self, **kwargs) -> APIResponse:
        """
        create_chatbot.
        ...
        try:
            ...
            logger.error(f"create_chatbot failed: {e}")
            raise

    async def get_chatbot(self, **kwargs) -> APIResponse:
        """
        get_chatbot.
        ...
        try:
            ...
            logger.error(f"get_chatbot failed: {e}")
            raise

    async def train_chatbot(self, **kwargs) -> APIResponse:
        """
        train_chatbot.
        ...
        try:
            ...
            logger.error(f"train_chatbot failed: {e}")
            raise

    async def chat(self, **kwargs) -> APIResponse:
        """
        chat.
...
async def main():
    """Example usage of BotsonicClient"""

    api_key = "your_api_key_here"

    async with BotsonicClient(api_key=api_key) as client:
        try:
            # Example: List items
