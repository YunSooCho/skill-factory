...
Yoom Apps Integration - Production-ready API client for beLazy
...
class BelazyClient:
    ...
    API Documentation: https://api.belazy.io/v1
    """
    ...
    def __init__(
        ...
        """
        Initialize Belazy API client.

        Args:
            api_key: Your Belazy API key
    ...
    async def create_task(self, **kwargs) -> APIResponse:
        """
        create_task.
    ...
    async def get_task(self, **kwargs) -> APIResponse:
        """
        get_task.
    ...
    async def update_task(self, **kwargs) -> APIResponse:
        """
        update_task.
...
async def main():
    """Example usage of BelazyClient"""

    api_key = "your_api_key_here"

    async with BelazyClient(api_key=api_key) as client:
        try:
            # Example: List items
