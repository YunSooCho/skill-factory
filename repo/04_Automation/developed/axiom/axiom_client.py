...
Yoom Apps Integration - Production-ready API client for axiom
...
class AxiomClient:
    ...
    API Documentation: https://api.axiom.co/v1
    """
    ...
    async def ingest_events(self, **kwargs) -> APIResponse:
        """
        ingest_events.
        ...
        try:
            ...
            logger.error(f"ingest_events failed: {e}")
            raise

    async def query_events(self, **kwargs) -> APIResponse:
        """
        query_events.
    ...
    async def list_datasets(self, **kwargs) -> APIResponse:
        """
        list_datasets.
    ...
    async def get_dataset(self, **kwargs) -> APIResponse:
        """
        get_dataset.
...
async def main():
    """Example usage of AxiomClient"""

    api_key = "your_api_key_here"

    async with AxiomClient(api_key=api_key) as client:
        try:
            # Example: List items
