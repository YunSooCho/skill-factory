"""
Craftmypdf API Client

Yoom Apps Integration - Production-ready API client for craftmypdf
...
class CraftmypdfClient:
    ...
    API Documentation: https://api.craftmypdf.com/v1
    """
    ...
    def __init__(
        ...
        """
        Initialize Craftmypdf API client.

        Args:
            api_key: Your Craftmypdf API key
    ...
    async def get_pdf(self, **kwargs) -> APIResponse:
        """
        get_pdf.
        ...
        try:
            ...
            logger.error(f"get_pdf failed: {e}")
            raise
...
async def main():
    """Example usage of CraftmypdfClient"""
