...
> Dynalist provides outliner and note-taking tools.
...
Get your API credentials from dynalist:

1. Sign up at the official dynalist website
...
```python
from dynalist import DynalistClient
...
For more information, visit the official dynalist documentation.
