...
Yoom Apps Integration - Production-ready API client for whereby
...
class WherebyClient:
    ...
    API Documentation: https://api.whereby.com/v1
    """
    ...
    def __init__(
        ...
        """
        Initialize Whereby API client.

        Args:
            api_key: Your Whereby API key
    ...
    async def create_meeting(self, **kwargs) -> APIResponse:
        """
        create_meeting.
    ...
    async def get_meeting(self, **kwargs) -> APIResponse:
        """
        get_meeting.
    ...
    async def update_meeting(self, **kwargs) -> APIResponse:
        """
        update_meeting.
        ...
        try:
            ...
            logger.error(f"update_meeting failed: {e}")
            raise

    async def delete_meeting(self, **kwargs) -> APIResponse:
        """
        delete_meeting.
        ...
        try:
            ...
            logger.error(f"delete_meeting failed: {e}")
            raise

    async def list_meetings(self, **kwargs) -> APIResponse:
        """
        list_meetings.
        ...
        try:
            ...
            logger.error(f"list_meetings failed: {e}")
            raise
...
async def main():
    """Example usage of WherebyClient"""
