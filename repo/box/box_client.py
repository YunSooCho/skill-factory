"""
Cloud content management and file storage API Client
...
class BoxClient:
    """
    Async client for Cloud content management and file storage
    ...
    async def upload_file(self, **kwargs) -> BoxResponse:
        """
        Upload File
    ...
    async def download_file(self, **kwargs) -> BoxResponse:
        """
        Download File
    ...
    async def delete_file(self, **kwargs) -> BoxResponse:
        """
        Delete File
    ...
    async def get_item(self, item_id: str) -> BoxResponse:
        ...
        Returns:
            BoxResponse with item details
        """

        return await self._request('GET', f'/items/{item_id}')

    async def create_item(self, data: Dict[str, Any]) -> BoxResponse:
        """
        Create a new item
        ...
        Returns:
            BoxResponse with created item
        """

        return await self._request('POST', '/items', data=data)

    async def update_item(self, item_id: str, data: Dict[str, Any]) -> BoxResponse:
        """
        ...
        Returns:
            BoxResponse with updated item
        """

        return await self._request('PUT', f'/items/{item_id}', data=data)

    async def delete_item(self, item_id: str) -> BoxResponse:
        """
        Delete an item
    ...
    async def health_check(self) -> BoxResponse:
        """
        Check API health status

        Returns:
            BoxResponse with health status
        """
