...
Yoom Apps Integration - Production-ready API client for deepgram
...
class DeepgramClient:
    ...
    API Documentation: https://api.deepgram.com/v1
    """
    ...
    async def transcribe_audio(self, **kwargs) -> APIResponse:
        """
        transcribe_audio.
    ...
    async def get_transcript(self, **kwargs) -> APIResponse:
        """
        get_transcript.
    ...
    async def list_projects(self, **kwargs) -> APIResponse:
        """
        list_projects.
    ...
    async def create_project(self, **kwargs) -> APIResponse:
        """
        create_project.
...
async def main():
    """Example usage of DeepgramClient"""
