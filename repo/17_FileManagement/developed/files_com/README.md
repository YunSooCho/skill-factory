# Files_Com API Client

Python async client for Secure file sharing and management platform. File Management.
...
```python
import asyncio
from files_com_client import FilesComClient

async def main():
    api_key = "your_api_key_here"

    async with FilesComClient(api_key) as client:
        # List items
