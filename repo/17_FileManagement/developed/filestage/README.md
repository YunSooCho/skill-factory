# Filestage API Client

Python async client for File review and approval platform. File Management.
...
```python
import asyncio
from filestage_client import FilestageClient

async def main():
    api_key = "your_api_key_here"

    async with FilestageClient(api_key) as client:
        # List items
