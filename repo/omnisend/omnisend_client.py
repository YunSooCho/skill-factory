...
class #OmnisendClient:
    """
    # Omnisend API Client with rate limiting and error handling
    """
    
    def __init__(self, api_key: Optional[str] = None, base_url: Optional[str] = None):
        """
        Initialize # Omnisend API client
        
        Args:
            api_key: API key for authentication
            base_url: Base URL for API endpoints
        """
        self.api_key = api_key or os.getenv(f"OMNISEND_API_KEY")
        self.base_url = base_url or "https://api.omnisend.com/v3"
    ...
    async def create_product_category(self, **kwargs) -> Dict[str, Any]:
        """
        ...
        Returns:
            Response data
        """
        endpoint = "/create_product_category"
        return await self._request("POST", endpoint, data=kwargs)
    ...
    async def seach_contact(self, **kwargs) -> Dict[str, Any]:
        """
        Seach Contact
        ...
        Returns:
            Response data
        """
        endpoint = "/seach_contact"
        return await self._request("POST", endpoint, data=kwargs)

    async def update_product(self, **kwargs) -> Dict[str, Any]:
        """
        Update Product
    ...
    async def list_categories(self, **kwargs) -> Dict[str, Any]:
        """
        List Categories
    ...
    async def send_event(self, **kwargs) -> Dict[str, Any]:
        """
        Send Event
    ...
    async def get_product(self, **kwargs) -> Dict[str, Any]:
        """
        Get Product
    ...
    async def delete_product(self, **kwargs) -> Dict[str, Any]:
        """
        Delete Product
    ...
    async def list_products(self, **kwargs) -> Dict[str, Any]:
        """
        List Products
