...
> Google Calendar API for managing calendars and events.
...
Get your API credentials from google-calendar:

1. Sign up at the official google-calendar website
...
For more information, visit the official google-calendar documentation.
